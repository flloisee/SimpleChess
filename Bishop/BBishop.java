    ...
    public void move(Turn turn, char board[][]) {
        ...
        while (turn == Turn.Black) {
            ...
            if (board[8 - row][col - 1] == '♝') {
                new checkBBishopMove().dispMoves(row, col, board);
                new checkBBishopMove().checkAttack(row, col, board);
                ...
                if (new checkBBishopMove().checkMove(rowF, colF, board) == false) {
                ...
                System.out.println("Selected piece is not a black bishop!");
                continue; 
            }
