    ...
    public void move(Turn turn, char board[][]) {
        ...
        while (turn == Turn.Black) {
            ...
            if (board[8 - row][col - 1] == '♛') {
                new checkBQueenMove().dispMoves(row, col, board);
                new checkBQueenMove().checkAttack(row, col, board);
                ...
                if (new checkBQueenMove().checkMove(rowF, colF, board) == false) {
