    ...
    public void move(Turn turn, char board[][]) {
        ...
        while (turn == Turn.White) {
            ...
            if (board[8 - row][col - 1] == '♔') {
                new checkWKingMove().dispMoves(row, col, board);
                new checkWKingMove().checkAttack(row, col, board);
                ...
                if (new checkWKingMove().checkMove(rowF, colF, board) == false) {
                    ...
                    if (new checkWKingMove().castling(row, col, board) == true) {
                ...
                System.out.println("Selected piece is not a white king!");
                continue; 
            }
