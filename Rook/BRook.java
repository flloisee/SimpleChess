    ...
    public void move(Turn turn, char board[][]) {
        ...
        while (turn == Turn.Black) {
            ...
            if (board[8 - row][col - 1] == '♜') {
                new checkBRookMove().dispMoves(row, col, board);
                new checkBRookMove().checkAttack(row, col, board);
                ...
                if (new checkBRookMove().checkMove(rowF, colF, board) == false) {
                ...
                System.out.println("Selected piece is not a black rook!");
                continue; 
            }
